...
public class ActivityReservation extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        type =  getIntent().getStringExtra("type");
            ...
            cat_type =  getIntent().getStringExtra("cat_type");
            time =  getIntent().getStringExtra("time");
            ORDER_LIST =  getIntent().getStringExtra("ORDER_LIST");

       // cat_type = getIntent().getExtras();
    ...
    public void resultAlert(String HasilProses) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Intent intent = new Intent(ActivityReservation.this,
