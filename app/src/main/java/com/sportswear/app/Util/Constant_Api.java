package com.sportswear.app.Util;

import com.sportswear.app.BuildConfig;
import com.sportswear.app.Item.AboutUsList;
...
public class Constant_Api {
    ...
    //main server api url
    //http://ravishah.xyz/foodcart/
    //public static String url = "http://192.168.1.102/foodcart/";
    public static String url = "http://gmusodza.kacee.co.zw/snaga/";
       public static String MY_PREFS_NAME="snaga";
    public static final String APP_TEMP_FOLDER = "snaga";
    ...
    public static String single=url + "getSingle.php?pid=";
