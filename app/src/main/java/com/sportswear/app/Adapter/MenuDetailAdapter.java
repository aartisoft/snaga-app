...
import com.sportswear.app.Activity.ProductDetailsActivity;
    ...
    public void onBindViewHolder(final MenuDetailAdapter.ViewHolder holder, final int position) {
        ...
        holder.imageView_Gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("pDes",menuLists.get(position).getDesc());
                intent.putExtra("pImage",menuLists.get(position).getImage());
                intent.putExtra("pPrice",menuLists.get(position).getPrice());
                intent.putExtra("pName",menuLists.get(position).getName());
