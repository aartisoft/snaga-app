...
import com.sportswear.app.Adapter.MyOrdersAdapter;
import com.sportswear.app.Item.MyOrderList;
                ...
                try {
                    ...
                    galleryLists.clear();
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            galleryLists.add(new MyOrderList(id, mobileid, name, address, phone,
                                    order_list, datetime, status, comment, email, order_type, del_msg,
                                    del_time,del_done,cat_type,adtime,addate,admsg));
                        }
